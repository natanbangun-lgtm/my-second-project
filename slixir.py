...
class ProfessionalCalculator(tk.Tk):
    def __init__(self):
        ...
        # --- Langkah 1: Buat semua widget (tombol, layar, dll) ---
        self.create_widgets()

        # --- Langkah 2: Atur nilai awal kalkulator (setelah widget ada) ---
        self.reset_state()

        # --- Langkah 3: Aktifkan input dari keyboard ---
    ...
    def create_widgets(self):
        """Menciptakan semua elemen visual kalkulator."""
        ...
        # --- Display Utama ---
        self.display_var = tk.StringVar()  # Variabel ini DIBUAT di sini
